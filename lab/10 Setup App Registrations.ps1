...
foreach ($environmentName in $environments)
{
    ...
    foreach ($identity in $environment.Identities.GetEnumerator())
    {
        ...
        {
            Write-Error "The application secret for the identity '$($identity.Name)' in environment '$environmentName' is not '<AutoGeneratedLater>'. Please undo the changes to the file and try again." -ErrorAction Stop
        }
